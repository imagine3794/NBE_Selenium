...
public class EnterVehicleDataTestMazda extends BaseTest {
 
  @Test(dataProvider = "SearchProvider")
  @Description("Test entering vehicle data for a Mazda car")
  ...
  public Object[][] getDataFromDataprovider(Method m){
    if(m.getName().equalsIgnoreCase("testEnterVehicleData")){
      return new Object[][] {
        { "Mazda", "100", "12/15/2024", "5", "Gas", "500", "ABC123", "10000" }
      };
    }
    return new Object[][] {};
  }
